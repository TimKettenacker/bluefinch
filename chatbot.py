...
class Chatbot(object):
    ...
    def update_conversation(self, input=None, **kwargs):
        ...
        If the intermediate fall into the confidence interval, they are then cross-checked with the
        ontology search and reasoning module which compares the findings to the current and historical
        context.
